{
  ...
  :looking_for => ["Continuous Learning", 'Excited co-workers', "A company with strong vision"],
  ...
  :code => {
    ...
    :project_1 => {
      ...
      :what_to_look_for => ['HyperMedia API endpoint at /api/v1', 'Native-app feel from the user interface', 'Test-driven development']
    },
    :project_2 => {
      :title => "FreshFinder - find reliable farmer's market information",
      :description => "FreshFinder helps users find reliable farmer's market information. By allowing community editing, information stays current. Users can rate markets and help other users find the right markets for them locally.",
      :url => 'http://github.com/FreshFinder',
      :what_to_look_for => ['Hypermedia API', 'Multiple services working together', 'JavaScript frontend']
    },
    :project_3 => {
      ...
      :what_to_look_for => ['Multi-user, multi-role implementation', 'Administrative interface', 'Multi-restaurant shopping cart']
    }
  },
