{
  ...
  :code => {
    ...
    :project_2 => {
      :title => "Fourth Meal",
      :description => "Worked with a legacy codebase of an individual restaurant online ordering system to build a restaurant platform capable of hosting thousands of restaurants.",
      :url => 'http://github.com/BryanaKnight/fourth_meal',
      :what_to_look_for => ['background workers', "'Russian Doll' fragment caching", 'scalable architecture']
    },
    :project_3 => {
      :title => "Walk It Off",
      :description => "Fitness and Nutrition app built using SOA. Includes integration with the Fitbit and Fatsecret API’s.",
      :url => 'https://github.com/BryanaKnight/walk_if_off',
      :what_to_look_for => ['SOA', 'JavaScript charts']
    }
  },
