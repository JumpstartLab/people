{
  ...
  :locations => ["Denver, CO", "Boulder, CO", "San Francisco, CA", "Seatle, WA", "Boston, MA", "Washington, D.C."],
  :code => {
    ...
    :project_3 => {
      ...
      :what_to_look_for => ['Consistancy of solutions', 'Solid understanding of changing the state of an object']
    }
  },
